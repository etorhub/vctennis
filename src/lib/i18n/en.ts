export const en = {
  ...
  endBooking: "End booking",
  endBookingNow: "End now",
  bookingEnded: "Booking ended — the court is free again",
  bookingInProgress: "Your booking is in progress",
  bookingInProgressUntil: "Until {time}",
  endBookingHelp: "End it early and the rest of your slot is released for anyone to book.",
  endBookingFrees: "Frees {time} onwards",
  endBookingFreesAll: "Frees the whole slot",
  confirmEndBooking: "End your booking now? The remaining time is released and someone else can book it.",
  endedEarly: "Ended early",
  errorNotStarted: "That booking has not started yet.",
  errorAlreadyEnded: "That booking was already ended.",
  ...
  eventBookingEnded: "Booking ended early",
  ...
  rulesContactTitle: "Contact / report an issue",
  rulesContactIntro: "Get in touch with the community admins, or report a problem with the court.",
  rulesContactSignInPrompt: "Sign in to send a message to the admins.",
  rulesContactSendingAs: "Sending as {name} ({email})",
  rulesContactType: "Type",
  rulesContactTypeContact: "Contact",
  rulesContactTypeIncident: "Report an issue",
  rulesContactSubject: "Subject",
  rulesContactSubjectPlaceholder: "Short summary",
  rulesContactMessage: "Message",
  rulesContactMessagePlaceholder: "Describe your question or the issue",
  rulesContactSubmit: "Send",
  rulesContactSuccess: "Thanks! Your message has been sent to the admins.",
  rulesContactError: "Could not send your message. Please try again.",
